...
const ForestScene = lazy(() => import('./components/shared/ForestScene'))
  ...
  if (!started) {
    return (
      <div className="h-screen flex overflow-hidden">
        ...
        >
          <Suspense fallback={<div className="w-full h-full bg-[#0a0f0a] flex items-center justify-center"><span className="font-mono text-[11px] text-white/30">Loading 3D...</span></div>}>
            <ForestScene />
          </Suspense>
        </motion.div>
      </div>
